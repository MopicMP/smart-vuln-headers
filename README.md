...
> Smart scan for vulnerable http headers

[![PyPI version](https://badge.fury.io/py/smart-vuln-headers.svg)](https://pypi.org/project/smart-vuln-headers/)
...
```bash
pip install smart-vuln-headers
```

## Quick Start

```python
from smart_vuln_headers import headers
...
from smart_vuln_headers import batch
